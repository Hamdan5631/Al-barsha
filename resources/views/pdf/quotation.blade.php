...
<body>
@php
    $quotationDate = \Illuminate\Support\Carbon::parse($quotation->date)->format('d/m/Y');
    $items = $quotation->items;
    $lineCount = max(18, $items->count());
    $totalDhsFils = \App\Support\AedMoney::splitDhsFils((float) $quotation->total_amount);
    $settings = $settings ?? [
...
<div class="meta-strip">
    <table class="meta-inner">
        <tr>
            <td colspan="2">
                <span class="meta-label">To:</span><span class="meta-to-val dynamic-content">{{ \App\Support\ArabicPdfText::forDomPdf($quotation->customer_name) }}</span>
            </td>
        </tr>
        <tr>
            <td>
                <span class="meta-label">Quotation No:</span>
                <span class="dynamic-content">{{ $quotation->quotation_number }}</span>
            </td>
            <td class="meta-right">
                <span class="meta-label">Date:</span>
                <span class="dynamic-content">{{ $quotationDate }}</span>
            </td>
        </tr>
    </table>
</div>
...
<div class="words-box">
    <table class="words-row">
        <tr>
            ...
            <td class="words-val dynamic-content">{{ \App\Support\AedMoney::inWords((float) $quotation->total_amount) }}</td>
        </tr>
    </table>
</div>
